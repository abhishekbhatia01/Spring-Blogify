  ...
  const cardsData = [
    {
      ...
      name: "Dev Sharma",
      handle: "@devwithcoffee",
      date: "March 12, 2025",
      testimonial:
        "Blogify helped me publish my first technical article on Spring Boot and it instantly connected me with other developers.",
    },
    {
      image:
      ...
      date: "April 5, 2025",
      testimonial:
        "I love how Blogify lets me focus on writing without worrying about design. The editor is clean and perfect for dev blogs.",
    },
    {
      image:
        "https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60",
      name: "Jordan Lee",
      handle: "@jordantalksdev",
      date: "May 2, 2025",
      testimonial:
        "Through Blogify I discovered amazing blogs on JavaScript and was able to share my own tutorials with a growing audience.",
    },
    {
      image:
      ...
      date: "May 20, 2025",
      testimonial:
        "Blogify feels like a developer-first blogging platform. The community is super supportive, and I’ve learned a lot here.",
    },
  ];
  ...
  return (
    <section className="py-16 bg-gray-50">
      <h2 className="text-center text-3xl font-bold mb-8">
        Loved by <span className="text-sky-600">Developers</span>
      </h2>
